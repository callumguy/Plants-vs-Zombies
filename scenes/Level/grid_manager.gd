...
func grid_pos_to_pos(grid_pos: Vector2) -> Vector2:
    return Vector2(
        LAWN_LEFT + grid_pos.x * cell_width + cell_width / 2,
        LAWN_TOP + grid_pos.y * cell_height + cell_height / 2
        )
...
func grid_range_to_range(grid_range: Vector2) -> Vector2:
    return Vector2(
        grid_range.x * cell_width,
        grid_range.y * cell_height
    )
